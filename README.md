...
"Only available <if [Imperial Fullysia] is constructed in all [capital] cities>", 
	...
	},
	{
		...
		"attacked": "The armies of Greece await you with open arms!",
		"defeated": "You have somehow become my undoing! What kind of beast are you?",
		"denounced": "Your slanderous tongue will make it all the more satisfying when I stand before the ruins of your capital!",
		"introduction": "Greetings! I am Alexander of Macedon, the King and the Pharaoh, the undefeated General of Greece!",
		...
		"uniques": ["Upon capturing a city, receive [5] times its [Science] production as [Science] immediately", "Upon capturing a city, receive [5] times its [Culture] production as [Culture] immediately", 
            "[+1 Food, +1 Culture, +1 Happiness] from every [Barracks]","[+1 Food, +1 Culture, +1 Happiness] from every [Armory]",
			"[{Military} {non-air}] units gain the [To the World's End] promotion <upon conquering a city>", "[-50]% Unhappiness from [Population] [in puppeted cities] <when at war>", "[+1 Happiness] [in puppeted cities] <when at war>"],
		"cities": ["Pella","Aigai","Amphipolis","Alexandropouli","Alexandria Troas","Alexandria","Alexandria Ariana",
			...
			"Alexandretta","Methone","Syracuse","Herakleia","Gortyn","Chalkis","Pylos","Naxos","Sicyon",
			"Larissa","Messene","Orchomenos","Ambracia","Kos","Knidos",
			"Patras","Lamia","Nafplion","Apolyton"],
		"spyNames": ["Aeropus", "Adea", "Balacrus", "Berenice", "Caranus", "Cynane", "Koinos", "Europa", "Lysimachus", "Nicaea"]
	},
...
"Triggers a [Gantu] event <upon entering the [Modern era]>","Triggers a [Toothless] event <upon entering the [Atomic era]>",
	{
		"name": "Adaptable",
		"text": "[Renaissance]: Free [Functional] Tenet",
		"presentation": "Alert",
		"choices": [
			{
				"text": "Gunboat Diplomacy",
				"uniques": [
					"Adopt [Gunboat Diplomacy]",
					"Only available <before adopting [Gunboat Diplomacy]>",
					"[-10]% weight to this choice for AI decisions"
				]
			},
			{
				"text": "Treaty Organization",
				"uniques": [
					"Adopt [Treaty Organization]",
					"Only available <before adopting [Treaty Organization]>",
					"[+10]% weight to this choice for AI decisions"
				]
			},
			{
				...
				"uniques": [
					"Adopt [Iron Curtain]",
					"Only available <before adopting [Iron Curtain]>",
					"[-10]% weight to this choice for AI decisions",
					"[-90]% weight to this choice for AI decisions <when number of [Remaining [City-State] Civilizations] is less than [3]>"
				]
			},
		]
	},
